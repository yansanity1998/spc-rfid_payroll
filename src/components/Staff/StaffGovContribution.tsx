// src/components/Staff/StaffGovContribution.tsx
  ...
  return (
    <div className="min-h-screen w-full lg:ml-70 py-5 roboto px-3 sm:px-5 bg-red-200">
      <main className="flex flex-col w-full max-w-7xl mx-auto p-4 sm:p-6 bg-white border border-gray-200 shadow-2xl rounded-2xl">
        ...
        <div className="mb-8">
          <div className="group relative overflow-hidden bg-gradient-to-br from-red-500 to-red-600 p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-[1.02]">
                ...
                <div className="text-white">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-red-100 text-sm">Combined government mandated contributions</p>
                    </div>
                  </div>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {contributionBreakdown.map((item, index) => (
              <div
                key={index}
                className="group relative overflow-hidden bg-white border-2 border-gray-200 p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 hover:border-red-300"
              >
        ...
        {/* Information Section */}
        <div className="bg-gradient-to-r from-blue-50 to-red-50 border-2 border-blue-200 rounded-2xl p-6">
...
export default StaffGovContribution;
