                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex gap-2">
                          <button
                            ...
                            className="inline-flex items-center px-3 py-1.5 bg-red-600 text-white text-xs font-medium rounded-md hover:bg-red-700 transition-colors duration-200 shadow-sm hover:shadow-md"
                          >
              ...
              <div className="bg-gradient-to-r from-red-600 to-red-700 px-6 py-4 rounded-t-xl">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-red-100 text-sm">Period: {selectedPayroll.period}</p>
                  </div>
                  <button
