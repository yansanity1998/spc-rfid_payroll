      ...
      case "clearance":
        return (
          <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 20a7 7 0 0114 0v1H5v-1z" />
          </svg>
        );
      default:
        return (
        ...
        <div>
          ...
          <div className="flex flex-col items-center justify-center px-4 py-4 mb-4">
            <div className="relative">
              <div className="relative">
                {userProfilePicture ? (
                  ...
                  <div className="h-20 w-20 rounded-full bg-gradient-to-br from-red-400 to-red-600 flex items-center justify-center text-white font-bold text-xl ring-4 ring-white/30 shadow-xl">
            ...
            <div className="text-center mt-3">
              <p className="text-white text-lg font-bold">Faculty{userPosition && ` (${userPosition})`}</p>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="flex flex-col items-center justify-center px-4 py-3 mb-3">
                <div className="relative">
                  <div className="relative">
                    {userProfilePicture ? (
                      ...
                      <div className="h-16 w-16 rounded-full bg-gradient-to-br from-red-400 to-red-600 flex items-center justify-center text-white font-bold text-lg ring-4 ring-white/30 shadow-xl">
                        {userName ? userName.charAt(0).toUpperCase() : userEmail.charAt(0).toUpperCase()}
                      </div>
                    )}
                  </div>
                ...
                <div className="text-center mt-2">
                  <p className="text-white text-sm font-bold">Faculty{userPosition && ` (${userPosition})`}</p>
                </div>
              </div>
