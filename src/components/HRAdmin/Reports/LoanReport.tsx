                      ...
                      <td className="px-3 py-3 border-b border-gray-200">
                        {record.attachment ? (
                          <a
                            ...
                            className="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-medium bg-orange-100 text-orange-700 hover:bg-orange-200 transition-colors"
                          >
                            <svg
