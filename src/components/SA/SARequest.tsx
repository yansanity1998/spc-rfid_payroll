                        ...
                        <tr key={request.id} className="hover:bg-white/80 transition-all duration-200">
                          ...
                          <td className="px-3 sm:px-4 py-4 border-b border-gray-200 text-center">
                            <button
                              ...
                              className="px-3 py-1.5 bg-gradient-to-r from-yellow-600 to-yellow-700 text-white text-xs font-medium rounded-lg hover:shadow-lg transition-all duration-200 hover:scale-105"
                            >
                              View Details
                            </button>
                          </td>
