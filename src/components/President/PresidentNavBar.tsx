				...
				<div>
					...
					<div className="flex flex-col items-center justify-center px-4 py-4 mb-4">
						...
						<div className="text-center mt-3">
							<p className="text-white text-lg font-bold">President{userPosition && ` (${userPosition})`}</p>
						</div>
					</div>
						...
						<div>
							<div className="flex flex-col items-center justify-center px-4 py-3 mb-3">
								...
								<div className="text-center mt-2">
									<p className="text-white text-sm font-bold">President{userPosition && ` (${userPosition})`}</p>
								</div>
							</div>
